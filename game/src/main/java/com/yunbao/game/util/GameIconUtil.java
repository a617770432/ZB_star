...
public class GameIconUtil {
    ...
    private static SparseIntArray mLeftLhMap;
    private static SparseIntArray mRightLhMap;
    ...
    static {
        ...
        sGameIconMap.put(6, R.mipmap.icon_lhh);
        ...
        sGameNameMap.put(6, R.string.game_lhh);
        ...
        mLeftLhMap=new SparseIntArray();
        mLeftLhMap.put(1,R.drawable.bg_cic_l);
        mLeftLhMap.put(2,R.drawable.bg_cic_h);
        mLeftLhMap.put(3,R.drawable.bg_cic_he);

        mRightLhMap=new SparseIntArray();
        mRightLhMap.put(1,R.drawable.bg_ring_l);
        mRightLhMap.put(2,R.drawable.bg_ring_h);
        mRightLhMap.put(3,R.drawable.bg_ring_he);
    ...
    public static int getLeftLhMap(int key) {
        return mLeftLhMap.get(key);
    }
    public static int getRightLhMap(int key) {
        return mRightLhMap.get(key);
    }
