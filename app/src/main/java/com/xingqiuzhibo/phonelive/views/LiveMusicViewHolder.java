...
import com.xingqiuzhibo.phonelive.music.LiveMusicPlayer;
import com.xingqiuzhibo.phonelive.music.LrcTextView;
...
public class LiveMusicViewHolder extends AbsViewHolder implements View.OnClickListener, View.OnTouchListener {
    ...
    public LiveMusicViewHolder(Context context, ViewGroup parentView, KSYStreamer streamer) {
    ...
    public void init() {
        ...
        mLiveMusicPlayer.setActionListener(new LiveMusicPlayer.ActionListener() {
            ...
            @Override
            public void onLrcChanged(String lrc, int index) {
