...
import com.xingqiuzhibo.phonelive.socket.SocketLinkMicAnchorUtil;
...
import com.xingqiuzhibo.phonelive.views.LiveLinkMicPlayViewHolder;
import com.xingqiuzhibo.phonelive.views.LiveLinkMicViewHolder;
...
public class LiveLinkMicAnchorPresenter implements View.OnClickListener {
    ...
    private LiveLinkMicViewHolder mLiveLinkMicViewHolder;

    public LiveLinkMicAnchorPresenter(Context context, LiveLinkMicViewHolder linkMicViewHolder, boolean isAnchor, View root) {
        mContext = context;
        mIsAnchor = isAnchor;
        mRoot = root;
        mLiveLinkMicViewHolder = linkMicViewHolder;
    ...
    public void onLinkMicAnchorApply(UserBean u, String stream) {
        ...
        if (!mIsLinkMic && !mIsApplyDialogShow) {
            mApplyUid = u.getId();
            mApplyStream = stream;
            showApplyDialog(u);
        } else {
    ...
    public void onLinkMicAnchorPlayUrl(String pkUid, String playUrl) {
        ...
        mPlayingVideo = true;
        if (mLiveLinkMicViewHolder != null) {
            mLiveLinkMicViewHolder.changeToLeft();
        }
    ...
    public void onLinkMicAnchorClose() {
        ...
        if (mLiveLinkMicViewHolder != null) {
            mLiveLinkMicViewHolder.changeToBig();
        }
        mIsLinkMic = false;
        mApplyUid = null;
        mApplyStream = null;
