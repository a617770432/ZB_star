...
import com.xingqiuzhibo.phonelive.socket.SocketLinkMicUtil;
import com.xingqiuzhibo.phonelive.utils.ClickUtil;
...
import com.xingqiuzhibo.phonelive.views.LiveLinkMicPushViewHolder;
...
public class LiveLinkMicPresenter implements View.OnClickListener {
    ...
    public LiveLinkMicPresenter(Context context, LiveLinkMicViewHolder linkMicViewHolder, boolean isAnchor, View root) {
        mContext = context;
        mRoot = root;
        mIsAnchor = isAnchor;
