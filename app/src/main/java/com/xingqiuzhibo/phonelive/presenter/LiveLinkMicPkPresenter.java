...
import com.xingqiuzhibo.phonelive.custom.ProgressTextView2;
...
import com.xingqiuzhibo.phonelive.socket.SocketLinkMicPkUtil;
...
import com.xingqiuzhibo.phonelive.views.LiveLinkMicPkViewHolder;
...
public class LiveLinkMicPkPresenter implements View.OnClickListener {
    ...
    public LiveLinkMicPkPresenter(Context context, LiveLinkMicViewHolder linkMicViewHolder, boolean isAnchor, View root) {
        mContext = context;
        mIsAnchor = isAnchor;
        mRoot = root;
