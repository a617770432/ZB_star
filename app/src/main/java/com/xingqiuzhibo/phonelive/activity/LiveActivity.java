...
import com.xingqiuzhibo.phonelive.dialog.LiveChatListDialogFragment;
import com.xingqiuzhibo.phonelive.dialog.LiveChatRoomDialogFragment;
import com.xingqiuzhibo.phonelive.dialog.LiveGuardBuyDialogFragment;
import com.xingqiuzhibo.phonelive.dialog.LiveGuardDialogFragment;
import com.xingqiuzhibo.phonelive.dialog.LiveInputDialogFragment;
import com.xingqiuzhibo.phonelive.dialog.LiveRedPackListDialogFragment;
import com.xingqiuzhibo.phonelive.dialog.LiveRedPackSendDialogFragment;
...
import com.xingqiuzhibo.phonelive.interfaces.KeyBoardHeightChangeListener;
import com.xingqiuzhibo.phonelive.mob.MobCallback;
import com.xingqiuzhibo.phonelive.mob.MobConst;
import com.xingqiuzhibo.phonelive.mob.MobShareUtil;
import com.xingqiuzhibo.phonelive.mob.ShareData;
...
import com.xingqiuzhibo.phonelive.socket.SocketMessageListener;
import com.xingqiuzhibo.phonelive.utils.DpUtil;
import com.xingqiuzhibo.phonelive.utils.KeyBoardHeightUtil;
...
import com.xingqiuzhibo.phonelive.views.AbsLiveViewHolder;
import com.xingqiuzhibo.phonelive.views.LiveAddImpressViewHolder;
import com.xingqiuzhibo.phonelive.views.LiveAdminListViewHolder;
import com.xingqiuzhibo.phonelive.views.LiveContributeViewHolder;
...
public abstract class LiveActivity extends AbsActivity implements SocketMessageListener, LiveShareDialogFragment.ActionListener, KeyBoardHeightChangeListener {
    ...
    @Override
    public void onGameLhH(JSONObject obj) {
        if (mGamePresenter != null) {
            mGamePresenter.onGameLhSocket(obj);
        }
        if (mLiveRoomViewHolder!=null){
            mLiveRoomViewHolder.setGiftLayoutParam(true);
        }
    }

    @Subscribe(threadMode = ThreadMode.MAIN)
    public void onLhGameEnter(LhGameEnterEvent e) {
        if (mLiveRoomViewHolder!=null){
            mLiveRoomViewHolder.setGiftLayoutParam(true);
        }
    }
    @Subscribe(threadMode = ThreadMode.MAIN)
    public void onLhGameClose(LhGameCloseEvent e) {
        if (mLiveRoomViewHolder!=null){
            mLiveRoomViewHolder.setGiftLayoutParam(false);
        }
    }
