...
public class MoreWebViewActivity extends AbsActivity {
    ...
    protected int getLayoutId() {
        return R.layout.activity_webview_more;
    }
    ...
    protected void main() {
        ...
        mBtnMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                WebViewActivity.forward(mContext, AppConfig.HOST + "/index.php?g=Appapi&m=Diamonds&a=historical&uid=" + AppConfig.getInstance().getUid());
            }
        });
