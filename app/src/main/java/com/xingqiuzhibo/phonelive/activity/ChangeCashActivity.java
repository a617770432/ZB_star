...
import com.xingqiuzhibo.phonelive.adapter.ChangeCashAdapter;
...
public class ChangeCashActivity extends AbsActivity {

    private static final int PAGE_SIZE = 20;
    private int mNextRequestPage = 1;
    private RecyclerView mRecyclerView;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private ChangeCashAdapter mAdapter;
    private List<WithDrawCashBean> data;
    ...
    private void initAdapter() {
        mAdapter = new ChangeCashAdapter(R.layout.item_lv_change_cash, data);
    ...
    private void loadData() {
        ...
        NetWork.httpParamGet(UrlUtil.CHANGE_CASH_HISTORY, map, this, request);
    ...
    RequestCallBack<String> request = new RequestCallBack<String>() {
        ...
        public void onSuccess(ResponseInfo<String> responseInfo) {
            ...
            if (code == 0) {
                ...
                data = JSON.parseArray(JSON.toJSONString(arr), WithDrawCashBean.class);
