 ...
 * Time 2019/1/8/008.
 */
public class CoinHisActivity extends AbsActivity {
    private static final int PAGE_SIZE = 20;
    private int mNextRequestPage = 1;
    private RecyclerView mRecyclerView;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private CoinHisAdapter mAdapter;
...
//        loadData();
    ...
    private void initAdapter() {
        mAdapter = new CoinHisAdapter(R.layout.item_lv_coin_history, data);
    ...
    private void loadData() {
        ...
        NetWork.httpParamGet(UrlUtil.COIN_DETAIL_LIST, map, this, request);
