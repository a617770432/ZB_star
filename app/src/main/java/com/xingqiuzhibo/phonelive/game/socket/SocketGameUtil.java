package com.xingqiuzhibo.phonelive.game.socket;
...
import com.xingqiuzhibo.phonelive.socket.SocketSendBean;
...
public class SocketGameUtil {
    ...
    public static final int GAME_ACTION_LH_OPENVIEW=1;//开启游戏窗口
    public static final int GAME_ACTION_LH_STARTBET=2;//主播点击开始，游戏开始,可以开始下注
    public static final int GAME_ACTION_LH_BETING=3;//有人下注
    public static final int GAME_ACTION_LH_BETEND=4;//下注倒计时结束
    public static final int GAME_ACTION_LH_BANLANCE_RESULT=5;//主播点结束 出游戏结果
    public static final int GAME_ACTION_LH_BANLANCE_RESULT2=7;//主播点结束 出游戏结果
    public static final int GAME_ACTION_LH_CLOSE=6;//主播关闭游戏
