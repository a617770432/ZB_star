...
import com.xingqiuzhibo.phonelive.game.dialog.GameNzLsDialogFragment;
import com.xingqiuzhibo.phonelive.game.dialog.GameNzSfDialogFragment;
import com.xingqiuzhibo.phonelive.game.dialog.GameNzSzDialogFragment;
...
public class GameNzViewHolder extends AbsGameViewHolder {
    ...
    public void release() {
        ...
        if (mGameNzSzDialogFragment != null) {
            mGameNzSzDialogFragment.dismissAllowingStateLoss();
        }
