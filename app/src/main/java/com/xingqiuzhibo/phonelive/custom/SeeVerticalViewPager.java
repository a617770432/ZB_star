...
public class SeeVerticalViewPager extends ViewPager {

    private boolean isVertical = false;

    public SeeVerticalViewPager(@NonNull Context context) {
        super(context);
    }

    public SeeVerticalViewPager(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
