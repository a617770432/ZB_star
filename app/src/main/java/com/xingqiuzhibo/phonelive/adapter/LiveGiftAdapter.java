...
import com.xingqiuzhibo.phonelive.custom.GiftMarkView;
...
public class LiveGiftAdapter extends RecyclerView.Adapter<LiveGiftAdapter.Vh> {
    ...
    public LiveGiftAdapter(LayoutInflater inflater, List<LiveGiftBean> list, String coinName) {
        ...
        mAnimation = new ScaleAnimation(1f, 1.3f, 1f, 1.3f, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
