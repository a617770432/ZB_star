...
public class HttpConsts {
    ...
    public static final String GET_OFF_ORDER = "offlineOrder";
    public static final String CANCEL_ORDER = "cancelOrder";
    public static final String CANCEL_APPEAL = "cancelAppeal";
    ...
    public static final String GAME_LH_OPENVIEW= "dragonbegin";
    public static final String GAME_LH_START= "Dragonstart";
    public static final String GAME_LH_VOTES= "Dragonvotes";
